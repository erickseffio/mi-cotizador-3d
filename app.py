...
texts = {
    "Español (Perú S/.)": {
        ...
        "ref_label": "Subir Referencia",
        "p_name_ph": "Ej: Juan Pérez",
        "char_name_ph": "Ej: Iron Man Mark 85",
        "step1": "1️⃣ Datos del Proyecto", 
        "step2": "2️⃣ Configuración Artística", 
        "step3": "3️⃣ Inversión Estimada",
        ...
        "tab_print": "💧 Estructura y Escala ", 
        "tab_paint": "🖌️ Acabado Artístico", 
        "tab_design": "🧊 Diseño",
        "height_label": "Altura (cm)", 
        "comp_label": "Complejidad", 
        "comp_opts": ["Coleccionista", "Épico", "Obra Maestra"],
        ...
        "final_price_label": "PRECIO ESTIMADO", 
        "saving_label": "Ahorro Aplicado",
        "savings_title": "Descuento de Taller Aplicado!", 
        "wa_btn": "📲 Enviar Pedido a WhatsApp", 
        "note": "⚠️ El inicio de producción requiere el 50% de adelanto.",
    ...
    "Español (España €)": {
        ...
        "img_info": "Sube una foto de tu modelo para una mejor estimación.",
        "warning_input": "⚠️ **Atención:** Debes ingresar tu **Nombre** y el **Personaje** arriba para activar el botón de WhatsApp.",
        "footer_text": "Diseñado por Maker 3D Perú | Envíos internacionales"
    },
    "English €": {
        "simbolo": "€",
        "title": "Maker3DPeru-Italia",
        ...
        "ref_label": "Upload Reference",
        "p_name_ph": "e.g. John Doe",
        "char_name_ph": "e.g. Spider-Man",
        "step1": "1️⃣ Project Details", 
        "step2": "2️⃣ Artistic Configuration", 
        "step3": "3️⃣ Estimated Investment",
        "pdf_title": "3D PRINTING BUDGET",
        "pdf_imp": "Printing Cost",
        "final_quote": "Estimated Investment",
        "pdf_dis": "Design Cost",
        "pdf_pin": "Paint Cost",
        "tab_print": "💧 Structure and Scale", 
        "tab_paint": "🖌️ Artistic Finish", 
        "tab_design": "🧊 Design",
        "height_label": "Height (cm)", 
        "comp_label": "Complexity", 
        "comp_opts": ["Collector's Item", "Epic", "Masterpiece"],
        ...
        "final_price_label": "ESTIMATED PRICE", 
        "saving_label": "Total Savings",
        "savings_title": "Workshop Discount Applied!",
        "wa_btn": "📲 Send Order to WhatsApp", 
        "note": "⚠️ Production starts after 50% deposit.",
        ...
        "warning_input": "⚠️ **Attention:** Please enter your **Name** and **Character** to enable WhatsApp.",
        "footer_text": "Designed by Maker 3D Perú | International Shipping"
    },
    "Italiano €": {
        "simbolo": "€",
        "title": "Maker3DPeru-Italia",
        ...
        "ref_label": "Carica Riferimento",
        "p_name_ph": "es: Alessandro Rossi",
        "char_name_ph": "es: Darth Vader",
        "step1": "1️⃣ Dettagli Progetto", 
        "step2": "2️⃣ Configurazione Artistica", 
        "step3": "3️⃣ Investimento Stimato",
        ...
        "tab_print": "💧 Struttura e proporzioni", 
        "tab_paint": "🖌️ finitura artistica", 
        "tab_design": "🧊 Design",
        "height_label": "Altezza (cm)", 
        "comp_label": "Complessità", 
        "comp_opts": ["Oggetto da collezione", "epico", "capolavoro"],
        ...
        "design_opts": [
            ...
            "Personalizado - Modifica della posa o aggiunta nomi",
            "Premium - Modellazione da zero o scultura complessa"
        ],
        "final_price_label": "PREZZO STIMATO", 
        "saving_label": "Risparmio Applicato",
        "savings_title": "Sconto per il workshop applicato!",
        "wa_btn": "📲 Invia Ordine su WhatsApp", 
        ...
        "port_desc": "Esplora le nostre ultime creazioni in resina e pittura artistica.",
        ...
        "warning_input": "⚠️ **Attenzione:** Inserisci il tuo **Nome** e el **Personaggio** per attivare WhatsApp.",
